...
typedef enum {
    ...
    ATH_EVENT_RPWAHD_DEBUG_EVENT = 100
} ATH_RPWAHD_EVENT;

/**
 * Command types that are asynchronously generated by the userpace tp_mesh
 */
typedef enum {
    ATH_CMD_RPWAHD_DEAUTH_CMD = 1,
    ATH_CMD_RPWAHD_BLACK_LIST_CMD = 2,
    ATH_CMD_RPWAHD_11V_STEER_CMD = 3,
    ATH_CMD_RPWAHD_STA_ASSOC_STATUS_CMD = 4,
    ATH_CMD_RPWAHD_INTF_STATUS_CMD = 5,
    ATH_CMD_RPWAHD_INTF_INFO_CMD = 6,
    ATH_CMD_RPWAHD_DEBUG_CMD = 100
} ATH_RPWAHD_CMD;
